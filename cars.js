...
const defaultCars = [
    ...
    },
    {
        ...
        year: 2023,
        price: 105,
        image: "https://images.unsplash.com/photo-1553440569-bcc63803a83d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80",
        status: "available"
    },
    {
        id: 17,
    ...
    },
    {
        ...
        year: 2023,
        price: 65,
        image: "https://images.unsplash.com/photo-1619682817481-e994891cd1f5?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80",
        status: "available"
    },
    {
        id: 19,
        ...
        year: 2023,
        price: 88,
        image: "https://images.unsplash.com/photo-1580273916550-e323be2ae537?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80",
        status: "available"
    },
    {
        id: 20,
        ...
        year: 2023,
        price: 120,
        image: "https://images.unsplash.com/photo-1560958089-b8a1929cea89?ixlib=rb-4.0.3&auto=format&fit=crop&w=1171&q=80",
        status: "available"
    }
...
function createCarCard(car) {
    ...
    card.innerHTML = `
        ...
        <div class="card-body d-flex flex-column">
            ...
            <p class="card-text"><i class="fas fa-calendar-alt me-2"></i>Year: ${car.year}</p>
            <p class="card-text"><i class="fas fa-tag me-2"></i>Price: <span class="price">Br${car.price}/day</span></p>
            <p class="card-text">
                <i class="fas fa-circle me-2"></i>Status: 
                <span class="${isAvailable ? 'status-available' : 'status-rented'}">
                    ${statusText}
                </span>
            </p>
            <div class="mt-auto">
